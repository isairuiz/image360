...
/**
 * Created by daxor on 28/07/2017.
 */
...
public class IconPageIndicator extends HorizontalScrollView implements PageIndicator {
	...
	public void notifyDataSetChanged() {
		...
		for (int i = 0; i < count; i++) {
			...
			view.setOnClickListener(new OnClickListener() { //CAMBIO se agregó listener
				@Override
				public void onClick(View view){
					setCurrentItem((int)view.getTag());
				}
			});
			mIconsLayout.addView(view, params); //CAMBIADO se agregó ",params)" como parámetros en addView()
		}
